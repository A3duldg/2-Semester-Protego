...
public class EmployeeDB implements EmployeeDBIF {
	private static final String CONNECT_SHIFT_TO_EMPLOYEE_Q =
	...
	public void connectShiftToEmployee(Employee employee, Shift shift) {
	    ...
	    try {
	        ...
	        if (rowsAffected > 0) {
	            System.out.println("Shift assigned successfully: employeeId=" + employee.getEmployeeId() + ", shiftId=" + shift.getShiftId());
	        } else {
